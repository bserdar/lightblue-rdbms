...
public class NullOperationFactory implements ScriptOperationFactory<NullOperation> {

    public static final String NAMES[]={NullOperation.NAME};
    ...
    @Override
    public NullOperation getOperation(OperationRegistry reg,ObjectNode node) {
        Path dest;

        ObjectNode args=(ObjectNode)node.get(NullOperation.NAME);
