...
public class ProjectionClause implements ProjectionItem {
    private SqlClause clause;

    public ProjectionClause(SqlClause clause) {
        this.clause=clause;
    }
    ...
    @Override
    public SqlClause getProjectionClause(ScriptExecutionContext ctx) {
        return clause;
    }
}
